...
(1, 'La Tour Eiffel a été inaugurée en 1889.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Vrai', TRUE),
(1, 'Quel océan borde la côte ouest de l''Afrique ?', 'Quiz', 5, 'Atlantique', 'Pacifique', 'Indien', 'Arctique', 'Atlantique', FALSE),
(1, 'Le symbole chimique de l''eau est H2O.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Vrai', TRUE),
(1, 'Quel pays est surnommé "le pays du Soleil-Levant" ?', 'Quiz', 5, 'Chine', 'Japon', 'Corée du Sud', 'Thaïlande', 'Japon', FALSE),
(1, 'La Terre a une lune appelée "Luna".', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Vrai', TRUE),
...
(2, 'La capitale de la Suisse est Zurich.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Faux', TRUE),
...
(2, 'La capitale de la Nouvelle-Zélande est Wellington.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Vrai', TRUE),
...
(3, 'Jeanne d''Arc a vécu au XVe siècle.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Vrai', TRUE),
...
(3, 'La bataille de Verdun a eu lieu pendant la Première Guerre mondiale.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Vrai', TRUE),
...
(3, 'La prise de la Bastille a eu lieu le 14 juillet.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Vrai', TRUE),
...
(4, 'L''unité de mesure de la force est le Newton.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Vrai', TRUE),
(4, 'Qui a formulé la théorie de la relativité ?', 'Quiz', 5, 'Isaac Newton', 'Albert Einstein', 'Galilée', 'Niels Bohr', 'Albert Einstein', FALSE),
(4, 'L''ADN est une molécule en double hélice.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Vrai', TRUE),
...
(4, 'Le langage Python a été créé avant Java.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Faux', TRUE),
...
(5, 'Dans "Friends", le nom du café est Central Perk.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Vrai', TRUE),
...
(5, 'L''acteur principal de "The Matrix" est Keanu Reeves.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Vrai', TRUE),
...
(5, 'La série "Breaking Bad" se déroule au Nouveau-Mexique.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Vrai', TRUE),
...
(6, 'Usain Bolt détient le record du 100 m.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Vrai', TRUE),
(6, 'Quel pays a remporté la Coupe du Monde 2018 ?', 'Quiz', 5, 'Brésil', 'Allemagne', 'France', 'Argentine', 'France', FALSE),
(6, 'Rafael Nadal a remporté plus de titres à Roland-Garros que Roger Federer.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Vrai', TRUE),
...
(6, 'La NBA est la ligue de basket nord-américaine.', 'Vrai/Faux', 5, 'Vrai', 'Faux', NULL, NULL, 'Vrai', TRUE),
