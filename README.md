...
- un **sujet** parmi : 🎬 *Cinéma et Séries TV*, 📡 *Sciences et Technologies*, 🏛️ *Histoire de France*
...
| Quiz ou scores vides | Scripts SQL non exécutés | Rejouer ⿡ ⿢ ⿣ via `docker exec ... psql -f` |
